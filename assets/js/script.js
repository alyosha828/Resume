var typed = new Typed("#typed", {
    strings: [
        ...
        "C/C++/C# Desktop App",
        "Wechat Mini Program",
        "PHP/Zend/ThinkPHP/Lalavel",
        "Windows/Linux Server development",
        "DB design & operating(MySQL, MariaDB, MongoDB, Postgre, etc)",
        "Node+ Express js",
    ],
    typeSpeed: 100,
    backSpeed: 85,
...
function videoPlay(currentItemActive) {
    let videoTitle = "";
    ...
    switch (currentItemActive.getElementsByClassName('item-title')[0].innerHTML) {
        ...
        case "Desktop App Development":
            ...
            poster += "11.jpg";
            break;
        case "Wechat Web/Mini App Development":
            videoTitle = "12.mp4";
            poster += "12.jpg";
            break;
        case "Windows/Linux Server, DB":
            videoTitle = "6.mp4";
            poster += "6.jpg";
            break;
        case "Html5/css3/Javascript":
            videoTitle = "13.mp4";
            poster += "13.jpg";
            break;
    }
